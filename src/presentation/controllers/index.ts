...
import { CategoryController, CategoryControllerV2, SongController, SongControllerV2 } from './song'
...
export const SongControllers = [ CategoryController, CategoryControllerV2, SongController, SongControllerV2 ]
