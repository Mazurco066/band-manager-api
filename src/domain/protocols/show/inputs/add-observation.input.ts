...
export class AddObservationInput {
  ...
  @ApiProperty({ type: String, required: true, example: 'My awesome observation' })
	title: string
  ...
  @ApiProperty({ type: String, required: true, example: 'My note here' })
	data: string
}
